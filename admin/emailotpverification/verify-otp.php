...
if($_SESSION['emailid']=='' ){
    ...
    //Code for otp generation and sending
    ...
    if(isset($_POST['verify'])){
        ...
        // Getting otp from session
        $storedOtp = $_SESSION['emailOtp'];
...
<div class="signup-form">
    <!-- Show OTP send form only when the OTP is not already sent -->
    <?php if(!isset($_POST['sendotp'])): ?>
    <form  method="post" action="">
		<div class="form-header">
			<h2>Verify Email</h2>
		</div>
		<button type="submit" name="sendotp" class="btn btn-primary btn-block btn-lg">Send OTP</button>
	</form>
    <?php endif; ?>

    <!-- Show OTP verify form when the OTP is already sent -->
    <?php if(isset($_POST['sendotp'])): ?>
    <form  method="post" action="">
		<div class="form-header">
			<h2>Verify OTP</h2>
